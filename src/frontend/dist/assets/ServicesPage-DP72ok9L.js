import { j as jsxRuntimeExports, d as cn, r as reactExports } from "./index-BbgXscAi.js";
import { g as useServicesAvailability, L as Layout, h as ServiceType, d as createActor } from "./Layout-D5VIdwoN.js";
import { B as Badge } from "./badge-C-QwoaHS.js";
import { B as Button } from "./button-BlVWhxCp.js";
import { C as Checkbox, T as TriangleAlert } from "./checkbox-l4gTain7.js";
...
import { u as useActor } from "./useActor-AG09Vf65.js";
import { C as Clock } from "./clock-DEQHJcJ4.js";
...
function ServicesPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-4 pb-24", "data-ocid": "services-page", children: [
      servicesAvailability && !servicesAvailability.available && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 20, className: "text-amber-600 flex-none mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-amber-900 leading-tight", children: "Services Temporarily Unavailable" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-800 mt-1 leading-relaxed", children: servicesAvailability.message || "Our community services are currently paused." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-700 mt-1.5 font-medium", children: "🔔 Services will resume soon — check back later." })
            ] })
          ]
        }
      ),
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 min-w-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-foreground leading-tight truncate", children: svc.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1 leading-relaxed line-clamp-2 break-words", children: svc.desc })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                disabled: actorFetching || (servicesAvailability ? !servicesAvailability.available : false),
                onClick: () => openBooking(svc),
                "data-ocid": `service-book-${svc.type.toLowerCase()}`,
                children: servicesAvailability && !servicesAvailability.available ? "Currently Unavailable" : "Request Service"
              }
            )
          ]
        },
