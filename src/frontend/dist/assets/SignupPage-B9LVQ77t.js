...
import { F as Fingerprint } from "./fingerprint-CH6OviPW.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-30 flex items-center justify-between px-5 py-3 bg-card border-b border-border shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(var(--primary))" }, children: "Assam" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(var(--secondary))" }, children: "Roots" })
              ]
            }
          ),
