import { ak as useRouterState, j as jsxRuntimeExports, L as Link, r as reactExports, u as useNavigate } from "./index-CstiQ4sz.js";
import { c as createLucideIcon } from "./createLucideIcon-ByrRp2U0.js";
import { i as useSiteSettings, e as useFooterSettings } from "./useQueries-CA65lisC.js";
...
function SearchBar({ initialFocus, placeholder }) {
  ...
  reactExports.useEffect(() => {
    var _a;
    if (initialFocus) (_a = inputRef.current) == null ? void 0 : _a.focus();
  }, [initialFocus]);
...
function useCart() {
  ...
  const getQuantity = reactExports.useCallback(
    (productId) => {
      var _a;
      return ((_a = items.find((i) => BigInt(i.product.id) === BigInt(productId))) == null ? void 0 : _a.quantity) ?? 0;
    },
    [items]
  );
...
const SOCIAL_ICONS = {
  ...
  facebook: /* @__PURE__ */ jsxRuntimeExports.jsx(Facebook, { size: 18 }),
  whatsapp: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { size: 18 }),
  youtube: /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { size: 18 })
};
function AppFooter() {
  const { data: footerSettings } = useFooterSettings();
  const tagline = (footerSettings == null ? void 0 : footerSettings.tagline) || "Bringing Assam to the World";
  const copyright = (footerSettings == null ? void 0 : footerSettings.copyright) || `© ${(/* @__PURE__ */ new Date()).getFullYear()} AssamRoots. All rights reserved.`;
  const socialLinks = (footerSettings == null ? void 0 : footerSettings.socialLinks) ?? [];
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      className: "bg-muted/40 border-t border-border",
      "data-ocid": "site-footer",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-section space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl font-bold text-primary", children: "AssamRoots" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "footer-tagline text-sm text-muted-foreground leading-relaxed", children: tagline }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "footer-copyright text-xs text-muted-foreground/70", children: copyright })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-section space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "footer-header text-sm font-semibold text-foreground", children: "About AssamRoots" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "Learn the story behind our platform and our mission to connect Assam to the world." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/about",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-section space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "footer-header text-sm font-semibold text-foreground", children: "Customer Reviews" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "Read what customers say about authentic Assamese products and services." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/reviews",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-section space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "footer-header text-sm font-semibold text-foreground", children: "Follow Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Stay connected with AssamRoots." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
            socialLinks.filter((s) => s.enabled && s.url).map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: s.url,
                target: "_blank",
                ...
                children: SOCIAL_ICONS[s.platform.toLowerCase()] ?? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs", children: s.platform[0].toUpperCase() })
              },
              s.platform
            )),
            socialLinks.filter((s) => s.enabled && s.url).length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "social-icon w-9 h-9 flex items-center justify-center rounded-full bg-muted text-muted-foreground/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { size: 18 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "social-icon w-9 h-9 flex items-center justify-center rounded-full bg-muted text-muted-foreground/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Facebook, { size: 18 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "social-icon w-9 h-9 flex items-center justify-center rounded-full bg-muted text-muted-foreground/40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Youtube, { size: 18 }) })
            ] })
          ] })
        ] })
      ] }) })
