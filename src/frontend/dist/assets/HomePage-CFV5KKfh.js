import { j as jsxRuntimeExports, L as Link, r as reactExports, S as Skeleton } from "./index-BbgXscAi.js";
import { a as useCart, u as useCategories, i as useProducts, L as Layout, j as useHeroBanners, k as useFeaturedBlocks, l as useVideoByte, X } from "./Layout-D5VIdwoN.js";
...
function HomePage() {
  ...
  const bestSellers = [...allProducts ?? []].sort((a, b) => Number(b.rating) - Number(a.rating)).slice(0, 8);
  const newArrivals = [...allProducts ?? []].sort((a, b) => Number(b.createdAt) - Number(a.createdAt)).slice(0, 6);
