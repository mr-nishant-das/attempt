import { u as useNavigate, j as jsxRuntimeExports, L as Link } from "./index-DUDks8tZ.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          items.some((i) => i.product.discountPercent > 0n) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-secondary/10 rounded-lg p-2 text-xs text-secondary font-semibold text-center", children: [
            "🎁 You're saving",
            " ",
            formatPrice(
              BigInt(
