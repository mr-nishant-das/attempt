import { a as useParams, r as reactExports, j as jsxRuntimeExports, S as Skeleton, L as Link } from "./index-CstiQ4sz.js";
import { createActor } from "./backend-Dxpf4-N4.js";
import { u as useCart, L as Layout, H as House, S as ShoppingCart } from "./Layout-BaVl6Ee_.js";
...
import { c as useProduct, b as useProductsByCategory } from "./useQueries-CA65lisC.js";
import { d as discountedPrice, r as ratingToFloat, f as formatPrice } from "./types-_UKd8--C.js";
...
import { C as ChevronLeft } from "./chevron-left-QJ48LRyd.js";
...
function ProductDetailPage() {
  ...
  const [vendorName, setVendorName] = reactExports.useState(null);
  const { data: product, isLoading } = useProduct(id);
  const { actor, isFetching: actorFetching } = useActor(createActor);
  reactExports.useEffect(() => {
    if (!actor || actorFetching || !id) return;
    actor.getVendorForProduct(id).then((result) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { hideSearch: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-32", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mt-5 space-y-4", children: [
      ...
      vendorName && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
        "Supplied by",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground", children: vendorName })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-4 bg-muted/30 rounded-2xl p-4 border border-border space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          ...
          children: "View Return & Refund Policy"
        }
      )
    ] }),
