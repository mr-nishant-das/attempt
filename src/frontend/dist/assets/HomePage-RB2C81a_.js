import { j as jsxRuntimeExports, L as Link, r as reactExports, e as ue, S as Skeleton } from "./index-CstiQ4sz.js";
import { u as useCart, L as Layout, b as Search, S as ShoppingCart, X } from "./Layout-BaVl6Ee_.js";
import { P as ProductCard } from "./ProductCard-DsevfTc4.js";
import { B as Badge } from "./badge-COIfXMhJ.js";
import { u as useCategories, i as useSiteSettings, j as useBestSellers, k as useNewArrivals, l as useHeroBanners, m as useFeaturedBlocks, n as useVideoByte } from "./useQueries-CA65lisC.js";
...
import "./button-T7X4xHPX.js";
import "./index-DbvNitIR.js";
import "./types-_UKd8--C.js";
import "./backend-Dxpf4-N4.js";
import "./star-185lLld2.js";
/**
...
const FALLBACK_BANNERS = [
  {
    id: 1n,
    imageUrl: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1400&q=85",
    title: "Connecting Assam to the World",
    subtitle: "Authentic Assamese products delivered to your doorstep, wherever you are.",
    ctaText: "Shop Now",
    ctaSlug: "assam-tea",
    order: 1n,
    isActive: true,
  ...
  {
    id: 2n,
    imageUrl: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=1400&q=85",
    title: "The Pride of Muga Silk",
    subtitle: "World-renowned Assamese Muga silk — only found in the Brahmaputra valley.",
  ...
  {
    id: 3n,
    imageUrl: "https://images.unsplash.com/photo-1596040033229-a9821ebd058d?w=1400&q=85",
  ...
  {
    id: 5n,
    imageUrl: "https://images.unsplash.com/photo-1549298916-b41d501d3772?w=1400&q=85",
    title: "Handcrafted with Tradition",
    subtitle: "Every product tells a story of Assamese artisans and their craft.",
  ...
  {
    id: 6n,
    imageUrl: "https://images.unsplash.com/photo-1529688530647-93a6e1916f5f?w=1400&q=85",
  ...
  {
    id: 7n,
    imageUrl: "https://images.unsplash.com/photo-1493925410384-84f842fd8fd8?w=1400&q=85",
    title: "Bihu — The Festival We Celebrate",
    subtitle: "AssamRoots is built on the spirit of Bihu — joy, community, and culture.",
  ...
  },
  {
    ...
    subtitle: "No middlemen. Direct from artisans, farmers, and weavers across Assam.",
  ...
  {
    id: 9n,
    imageUrl: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1400&q=85",
    title: "For the Assamese Diaspora",
    subtitle: "Live far from home? We bring Assam to you — authentic, fresh, and trusted.",
    ctaText: "Shop Now",
    ctaSlug: "assam-tea",
    order: 9n,
    isActive: true,
  ...
  {
    id: 10n,
    imageUrl: "https://images.unsplash.com/photo-1543168256-418811576931?w=1400&q=85",
    title: "Mekhela Chador — Woven with Love",
    subtitle: "Traditional Assamese attire passed down through generations of weavers.",
  ...
  {
    id: 11n,
    imageUrl: "https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=1400&q=85",
    title: "Natural Herbs & Ayurvedic Remedies",
    subtitle: "Traditional Assamese healing plants — nature's pharmacy from the Northeast.",
    ctaText: "Shop Herbs",
  ...
  {
    id: 12n,
    imageUrl: "https://images.unsplash.com/photo-1518791841217-8f162f1912da?w=1400&q=85",
    title: "Trust. Authenticity. AssamRoots.",
    subtitle: "Every product verified for authenticity. Every purchase supports Assamese livelihoods.",
...
function HeroBannerCarousel({
  ...
  const banners = fetchedBanners && fetchedBanners.length > 0 ? fetchedBanners.filter((b) => b.isActive) : FALLBACK_BANNERS;
  ...
  const scheduleNext = reactExports.useCallback(
    (idx, count) => {
      var _a;
      clearTimer();
      const duration = ((_a = banners[idx]) == null ? void 0 : _a.durationSeconds) ? Number(banners[idx].durationSeconds) : 5;
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full h-full absolute inset-0" })
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        tagline && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-0 left-0 right-0 z-20 bg-primary/90 px-4 py-2 text-center backdrop-blur-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-primary-foreground tracking-wider uppercase", children: tagline }),
          subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-primary-foreground/80 mt-0.5", children: subtitle })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0", children: banners.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: banners[active] && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] text-secondary/90 mb-1.5", children: "AssamRoots" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl md:text-4xl lg:text-5xl font-black text-white leading-tight mb-2 md:mb-3 max-w-2xl", children: banners[active].title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm md:text-base text-white/80 leading-relaxed max-w-lg", children: banners[active].subtitle })
            ] })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 left-0 right-0 z-30 flex justify-center items-center gap-1.5", children: banners.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => goTo(i),
            "aria-label": `Go to slide ${i + 1}`,
            className: `rounded-full transition-all duration-300 ${i === active ? "w-6 h-2.5 bg-secondary" : "w-2 h-2 bg-white/40 hover:bg-white/70"}`,
