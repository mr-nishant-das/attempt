const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Layout-D5VIdwoN.js","assets/index-BbgXscAi.js","assets/index-DJyLtdfV.css","assets/createLucideIcon-B6ccG8eC.js","assets/useActor-AG09Vf65.js","assets/trash-2-BuKpJiXj.js"])))=>i.map(i=>d[i]);
import { r as reactExports, _ as __vitePreload, A as createActorWithConfig, j as jsxRuntimeExports, z as useQueryClient, S as Skeleton } from "./index-BbgXscAi.js";
import { X, n as ServiceRequestStatus, L as Layout, o as useAdminHeroBanners, p as useAdminFeaturedBlocks, q as useSiteSettings, r as useSaveSiteSettings, h as ServiceType, d as createActor } from "./Layout-D5VIdwoN.js";
import { B as Button } from "./button-BlVWhxCp.js";
import { L as Label, I as Input } from "./label-_l6aeKyi.js";
import { c as createLucideIcon } from "./createLucideIcon-B6ccG8eC.js";
import { B as Badge } from "./badge-C-QwoaHS.js";
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogFooter } from "./dialog-DtZP2d6x.js";
...
import { u as ue } from "./index-DN6CyqvT.js";
...
import { T as Trash2 } from "./trash-2-BuKpJiXj.js";
import "./index-_KOCx7qY.js";
import "./index-BJkDSjMF.js";
/**
...
const KeyRound = createLucideIcon("key-round", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
  ...
  const uploadFile = reactExports.useCallback(
    async (file, onProgress) => {
      ...
      const { ExternalBlob } = await __vitePreload(async () => {
        const { ExternalBlob: ExternalBlob2 } = await import("./Layout-D5VIdwoN.js").then((n) => n.s);
      ...
      const { loadConfig } = await __vitePreload(async () => {
        const { loadConfig: loadConfig2 } = await import("./trash-2-BuKpJiXj.js").then((n) => n.i);
        return { loadConfig: loadConfig2 };
      }, true ? __vite__mapDeps([5,1,2,4,3]) : void 0);
...
const ADMIN_PASSCODE_HASH = "e74f2cbf96f8f8bc8d22f4f6b95bfb9a09bf52aa77bd98ef3b6ded28db6f49bd";
const SESSION_KEY = "adminSessionToken";
const SESSION_TS_KEY = "adminSessionTs";
const SESSION_DURATION_MS = 30 * 60 * 1e3;
...
function AdminLoginForm({ onSuccess }) {
  ...
  const passcodeRef = reactExports.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl shadow-elevated p-8 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Sign in to manage AssamRoots" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "admin-userid", className: "text-sm font-semibold", children: "Admin User ID" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "admin-userid",
            ...
            onKeyDown: (e) => {
              var _a;
              if (e.key === "Enter") (_a = passcodeRef.current) == null ? void 0 : _a.focus();
            },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "admin-passcode", className: "text-sm font-semibold", children: "Passcode" }),
...
const TABS = [
  { id: "herobanners", label: "Banners", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { size: 13 }) },
...
function HeroBannersPanel() {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      ue.success("Banner added");
      setAddOpen(false);
    } catch {
      ue.error("Failed to add banner");
    } finally {
      setSaving(false);
    }
  };
  const handleEdit = async () => {
    ...
    setSaving(true);
    try {
      await actor.adminUpdateHeroBanner(
        editDialog.banner.id,
        formToBannerInput(form)
      );
      await queryClient.invalidateQueries({ queryKey: ["adminHeroBanners"] });
      await queryClient.invalidateQueries({ queryKey: ["heroBanners"] });
      ue.success("Banner updated");
      setEditDialog({ open: false, banner: null });
    } catch {
      ue.error("Failed to update banner");
    } finally {
      setSaving(false);
    }
  };
  const handleDelete = async (id) => {
    ...
    try {
      await actor.adminDeleteHeroBanner(id);
      await queryClient.invalidateQueries({ queryKey: ["adminHeroBanners"] });
      await queryClient.invalidateQueries({ queryKey: ["heroBanners"] });
      ue.success("Banner deleted");
    } catch {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    !banners || banners.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "No banners yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Add your first homepage banner to get started." })
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: addOpen, onOpenChange: setAddOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-sm max-h-[90vh] overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Add Hero Banner" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: saving ? "Saving…" : "Update Banner"
              }
            )
          ] })
        ] })
...
function FeaturedBlocksPanel() {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await actor.adminDeleteFeaturedBlock(id);
      await queryClient.invalidateQueries({
        queryKey: ["adminFeaturedBlocks"]
      });
      await queryClient.invalidateQueries({ queryKey: ["featuredBlocks"] });
